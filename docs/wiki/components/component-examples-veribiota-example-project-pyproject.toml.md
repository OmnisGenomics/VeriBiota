---
page_id: component-component:examples/veribiota-example-project/pyproject.toml
page_type: component
generation_mode: inferred
freshness_status: new
updated_at: 2026-05-07T04:45:24.189Z
---
...
```json
{
  "freshnessKey": "24c7fec73f07389fdc85d0da451a4aed8d7dc220",
  ...
  "changedPaths": [
    ...
    "examples/veribiota-example-project",
...
Type: application
Root path: `examples/veribiota-example-project`
Ecosystem: python
...
- Run `python -m pytest` (test) from `examples/veribiota-example-project`.
